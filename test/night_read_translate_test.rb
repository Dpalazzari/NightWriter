...
class NightReadTest < Minitest::Test
  ...
  def test_carrots_and_pounds_returns_nil_if_no_capital_letter_exists
    nightread = NightRead.new(".0.0\n0.0.\n....")
    assert_equal "ii", nightread.carrots_and_pounds(["i", "i"])
  end

  def test_find_carrot_returns_a_word_with_a_capital_letter
    nightread = NightRead.new(".0.0\n0.0.\n....")
    assert_equal "Drew", nightread.carrots_and_pounds(["^", "d", "r", "e", "w"])
  end
